...
LZOHTable *create_keywords_table(const Allocator *allocator){
	...
	add_keyword("mod",      MOD_TOKEN_TYPE,      keywords, allocator);
	add_keyword("empty",    EMPTY_TOKEN_TYPE,    keywords, allocator);
    add_keyword("false",    FALSE_TOKEN_TYPE,    keywords, allocator);
    add_keyword("true",     TRUE_TOKEN_TYPE,     keywords, allocator);
    add_keyword("let",      LET_TOKEN_TYPE,      keywords, allocator);
    add_keyword("mut",      MUT_TOKEN_TYPE,      keywords, allocator);
    add_keyword("or",       OR_TOKEN_TYPE,       keywords, allocator);
    add_keyword("and",      AND_TOKEN_TYPE,      keywords, allocator);
	add_keyword("if",       IF_TOKEN_TYPE,       keywords, allocator);
    add_keyword("elif",     ELIF_TOKEN_TYPE,     keywords, allocator);
	add_keyword("else",     ELSE_TOKEN_TYPE,     keywords, allocator);
	add_keyword("while",    WHILE_TOKEN_TYPE,    keywords, allocator);
    add_keyword("for",      FOR_TOKEN_TYPE,      keywords, allocator);
	add_keyword("stop",     STOP_TOKEN_TYPE,     keywords, allocator);
    add_keyword("continue", CONTINUE_TOKEN_TYPE, keywords, allocator);
    add_keyword("array",    ARRAY_TOKEN_TYPE,    keywords, allocator);
	add_keyword("list",     LIST_TOKEN_TYPE,     keywords, allocator);
    add_keyword("to",       TO_TOKEN_TYPE,       keywords, allocator);
    add_keyword("dict",     DICT_TOKEN_TYPE,     keywords, allocator);
	add_keyword("record",   RECORD_TOKEN_TYPE,   keywords, allocator);
    add_keyword("proc",     PROC_TOKEN_TYPE,     keywords, allocator);
    add_keyword("anon",     ANON_TOKEN_TYPE,     keywords, allocator);
    add_keyword("ret",      RET_TOKEN_TYPE,      keywords, allocator);
    add_keyword("import",   IMPORT_TOKEN_TYPE,   keywords, allocator);
    add_keyword("as",       AS_TOKEN_TYPE,       keywords, allocator);
	add_keyword("bool",     BOOL_TOKEN_TYPE,     keywords, allocator);
	add_keyword("int",      INT_TOKEN_TYPE,      keywords, allocator);
	add_keyword("float",    FLOAT_TOKEN_TYPE,    keywords, allocator);
	add_keyword("str",      STR_TOKEN_TYPE,      keywords, allocator);
	add_keyword("is",       IS_TOKEN_TYPE,       keywords, allocator);
    add_keyword("try",      TRY_TOKEN_TYPE,      keywords, allocator);
    add_keyword("catch",    CATCH_TOKEN_TYPE,    keywords, allocator);
    add_keyword("throw",    THROW_TOKEN_TYPE,    keywords, allocator);
    add_keyword("export",   EXPORT_TOKEN_TYPE,   keywords, allocator);
